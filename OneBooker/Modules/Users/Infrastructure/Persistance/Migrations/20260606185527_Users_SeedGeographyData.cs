...
public partial class Users_SeedGeographyData : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.InsertData(
            schema: "Users",
            table: "Cities",
            columns: ["Id", "CreatedAt", "IsActive", "Name", "ProvinceId", "UpdatedAt"],
            values: new object[,]
            {
        ...
        migrationBuilder.InsertData(
            schema: "Users",
            table: "Countries",
            columns: ["Id", "CreatedAt", "IsActive", "Name", "UpdatedAt"],
            values: [1, null, true, "ایران", null]);

        migrationBuilder.InsertData(
            schema: "Users",
            table: "Provinces",
            columns: ["Id", "CountryId", "CreatedAt", "IsActive", "Name", "UpdatedAt"],
            values: new object[,]
            {
