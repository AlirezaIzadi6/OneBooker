...
public class CreateCountryServiceTests
{
    ...
    {
        // Arrange
        var countryDto = new CountryDto { Name = "Iran", IsActive = true };
        ...
        // Act
        var result = await _service.CreateCountry(countryDto);
    ...
    {
        // Arrange
        var countryDto = new CountryDto { Name = "Canada", IsActive = true };
